...
class AmazonSpider(scrapy.Spider):
   ...
   # How many pages you want to scrape
    ...
    def start_requests(self):
        ...
        urls = ["https://www.amazon.com/s?k=mobile&i=electronics-intl-ship&ref=nb_sb_noss"]
    ...
    def parse_product(self, response):
        ...
        yield Product(title = title.strip(), brand = brand.strip(), rating = rating.strip(), price = price.strip(), colour = colour.strip(), instock = instock, reviews = reviews, description = description, image_urls = [img_url])